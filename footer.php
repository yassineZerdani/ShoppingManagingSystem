						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Morocco ,oujda</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+212-642692048</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>yassinezerdani.gd@gmail.com</a></li>
								</ul>
							</div>
						</div>
